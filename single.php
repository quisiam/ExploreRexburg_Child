			    ...
			    if((empty($bg) && empty($bg_color)) && $fullscreen_header != true) { ?>
                    ...
                    <!--/single-below-header-->
                        ...
                        <div id="single-below-header">
								<!-- <span class="meta-author vcard author"><span class="fn"><?php echo __('By', NECTAR_THEME_NAME); ?> <?php the_author_posts_link(); ?></span></span>-->   <span class="meta-date date updated"><?php echo get_the_date(); ?></span><!--
